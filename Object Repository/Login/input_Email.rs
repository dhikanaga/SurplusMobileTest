...
<MobileElementEntity>
   ...
   <locator>new UiSelector().className(&quot;android.widget.EditText&quot;).text(&quot;Alamat e-mail&quot;).packageName(&quot;surplus.surplus_apps_customer&quot;).enabled(true).clickable(true).longClickable(true).checkable(false).checked(false).focusable(true).focused(false).scrollable(false).selected(false).index(2)</locator>
